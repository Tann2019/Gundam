...
<head>
    ...
    <title>Card Search - GundamDeck</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <a href="{{ route('cards.search') }}" class="text-blue-600 font-medium">Cards</a>
                    <a href="{{ route('deck.builder') }}"
                        class="text-gray-700 hover:text-blue-600 transition-colors">Deck Builder</a>
